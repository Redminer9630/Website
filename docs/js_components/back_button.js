export function initHeaderButton() {
  ...
  shadow.innerHTML = `
    <style>
      :host {all: initial;}
      button {all: unset;font-family: Mojangles;font-size: 16px;background-color: #f44336;color: white;padding: 10px 20px;border-radius: 8px;cursor: pointer;transition: background-color 0.2s ease, transform 0.2s ease;}
