document.addEventListener('DOMContentLoaded', function() {
    ...
    footer.innerHTML = `<span>© 2025 Offizielle Website von Redminer9630 - Alle Rechte vorbehalten. v1.5.3 Beta</span>`;
    document.body.appendChild(footer);
    const style = document.createElement('style');
    style.textContent = `
        @font-face { font-family: 'Minecraft', Arial; src: url('minecraft_font.woff'), format('.woff'), url('minecraft_font.ttf'), format('truetype'); }
        footer {
