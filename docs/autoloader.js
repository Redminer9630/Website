...
function loadMinecraftFontMiniFirst() {
	const fontMiniURL = "https://cdn.jsdelivr.net/gh/Redminer9630/Website@t32/docs/mcmini.woff2";
	const fontFullURL = "https://cdn.jsdelivr.net/gh/Redminer9630/Website@t32/docs/minecraft_font.woff2";
...
(function() {
	...
	preload.rel = "preload";
	preload.href = "https://cdn.jsdelivr.net/gh/Redminer9630/Website@t32/docs/js_components/framework.css";
	preload.as = "style";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fontPreload.as = "font";
    fontPreload.href = "https://cdn.jsdelivr.net/gh/Redminer9630/Website@t32/docs/minecraft_font.woff2";
    ...
    fontCSS.textContent = `
        @font-face {
            ...
            src: url('https://cdn.jsdelivr.net/gh/Redminer9630/Website@t32/docs/minecraft_font.woff2') format('woff2');
            font-display: swap;
        }
